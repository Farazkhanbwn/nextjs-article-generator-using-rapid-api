...
const GridIcon: React.FC<IconDimensions> = ({ width = 100, height = 100 }) => {
  return (
    <svg
      id="download"
    ...
    >
      ...
      <path
        id="Path_4"
        data-name="Path 4"
        d="M6,5V0H5V5H0V6H5v94H6V6h94V5Z"
        fill="rgba(255,255,255,0.1)"
        fill-rule="evenodd"
      />
    </svg>
